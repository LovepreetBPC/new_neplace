...
import com.neplace.customer.databinding.ActivityMapBoxBinding
...
class MapBoxActivity : AppCompatActivity() {
    ...
    var pickUpLat = "30.340000"
    var pickUpLong = "76.379997"
    var dropLat = "30.707600"
    var dropLong = "76.715126"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mapView.getMapboxMap().loadStyleUri(NavigationStyles.NAVIGATION_DAY_STYLE) {
            ...
            val mohaliPoint = Point.fromLngLat(dropLong.toDouble(), dropLong.toDouble())

            findRoute(mohaliPoint)

//            binding.mapView.gestures.addOnMapLongClickListener { point ->
//
//                Toast.makeText(this, "point", Toast.LENGTH_SHORT).show()
//                Log.e("rehal4321", "onCreate: $point")
//
//                val mohaliPoint = Point.fromLngLat(dropLong.toDouble(), dropLat.toDouble())
//
//                findRoute(mohaliPoint)
////                findRoute(point)
//                true
//            }
    ...
    private fun replayOriginLocation() {
        mapboxReplayer.pushEvents(listOf(ReplayRouteMapper.mapToUpdateLocation(Date().time.toDouble(), Point.fromLngLat(pickUpLong.toDouble(), pickUpLat.toDouble()))))
